...
hw.module @merge_range_covers_all(%0: i2) -> (a:i1) {
  ...
  %1 = comb.icmp bin eq %0, %c-2_i2  : i2
  %2 = comb.icmp bin eq %0, %c0_i2 : i2
  %4 = comb.icmp bin eq %0, %c-1_i2 : i2
  %5 = comb.icmp bin eq %0, %c1_i2 : i2
  %6 = comb.or bin %1, %2, %4, %5 : i1
  hw.output %6: i1
}
